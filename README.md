...
![](https://m.media-amazon.com/images/I/41Ie3xyyniL._AC_UF350,350_QL80_.jpg)

Датчик был выбран потому, что выдает сигнал сразу в цифровом виде, а это значит, что мы получаем уже готовые, обработанные данные без помех и потерь, как это бывает с аналоговыми сигналами. Благодаря этому достигается высокая точность измерений, так как оцифровка происходит прямо внутри датчика, и никакие внешние факторы уже не могут исказить информацию, которую мы считываем. Кроме того, это решение надежно в работе и при этом стоит недорого.
